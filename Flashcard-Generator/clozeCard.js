...
pantherCoachCloze.partial=new clozeCard("...is the coach of the Carolina Panthers.");
    ...
    if(user.card==="Basic"){
          ...
          inquirer.prompt([
            {
             ...
             name:"answer"
              ...
              if(answers.answer===pantherQb.back){
               console.log("You know your Panthers!");
               console.log("---------------------------------------------------------------------------------------------"); 
              }
              else{
                console.log("");
                console.log("Bucs fans that way!");
                console.log("");
             ...
             name:"answer"
              ...
              if(answers.answer===draftPick.back){
               ...
               console.log("---------------------------------------------------------------------------------------------"); 
                ...
                console.log("");
                console.log("Sorry, Atlanta is about 4 hours south bud...");
                console.log("");
                console.log("The correct answer is: ");
    	...
    	console.log("");
            ...
            console.log("---------------------------------------------------------------------------------------------");
	    			...
	    			console.log("");
	    			console.log("New Orleans is only cool one Tuesday in Feburary bro");
	    			console.log("");
	    			console.log("The correct answer is: ");
        ...
        inquirer.prompt([
        {
         ...
         name:"answer"
          ...
          if(answers.answer=== draftPickCloze.cloze){
            ...
            console.log("");
            console.log("Spy Gate cost us a Superbowl");
            console.log("");
            console.log("The correct answer is: ");
